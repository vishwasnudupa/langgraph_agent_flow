...
from src.tools.codebase_tools import search_code, read_file, list_directory, git_log, git_blame
from src.tools.analysis_tools import parse_c_symbols, find_callers, find_definitions, analyze_kconfig
...
- parse_c_symbols: extract functions/structs from C files
...
ANALYZER_TOOLS = [
    search_code, read_file, list_directory, git_log, git_blame,
    parse_c_symbols, find_callers, find_definitions, analyze_kconfig,
]
