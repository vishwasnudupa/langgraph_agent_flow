...
def debugger_node(state: AgentState) -> dict:
    ...
    if state.get("is_paradigm_shift"):
        prompt += "\n\n[PARADIGM SHIFT]: You are stuck in a failure loop. COMPLETELY DISCARD the previous strategy. Propose a radically different fix (e.g., disable feature, change subsystem, or revert)."
